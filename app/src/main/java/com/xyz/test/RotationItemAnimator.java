...
public class RotationItemAnimator extends android.support.v7.widget.DefaultItemAnimator{
    ...
    public static int TRANSLATION_X = 18; // (dp) 旋转时需要平移的距离
    ...
    private void runAnimatorSet(final View view, final RecyclerView.ViewHolder viewHolder) {
        ...
        int translationXPX = DpUtils.dp2px(view.getContext(), mTranslationX);
        ObjectAnimator animX = ObjectAnimator.ofFloat(view, "translationX", translationXPX);
